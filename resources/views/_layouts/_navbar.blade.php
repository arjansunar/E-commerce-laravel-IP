    ...
    <div class="container mx-auto px-6 py-3">
        ...
        <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
            <div class="flex flex-col sm:flex-row">
                ...
                <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="/shop">Shop</a>
            </div>
        </nav>
        <form @submit.prevent="window.location.href= name ? `/search/${name}`: ''" x-data="{name: ''}" class="relative mt-6 max-w-lg mx-auto">
            ...
            <input x-model="name"  class="w-full border rounded-md pl-10 pr-4 py-2 focus:border-blue-500 focus:outline-none focus:shadow-outline" type="text" placeholder="Search">
        </form>
    </div>
</header>